...
mixin _$Appointment {
 ...
 String get id; String get patientId; String get staffId; DateTime get slotStart; DateTime get slotEnd; VisitType get visitType; AppointmentStatus get status; DateTime get bookedAt; int get remindersSent; String? get departmentId; String? get reasonText; double? get noShowRisk; RiskBand? get riskBand;/// When the doctor pressed "Call patient" on the schedule ticket.
 DateTime? get calledInAt;/// When the doctor pressed "Patient arrived" — the visit is `inProgress`.
 DateTime? get checkedInAt;/// The doctor's closing summary, written at "Complete consultation".
 String? get outcomeNote;/// `[Hour letter A-X]-[facility-wide ticket number for that hour today]`,
...
as RiskBand?,calledInAt: freezed == calledInAt ? _self.calledInAt : calledInAt // ignore: cast_nullable_to_non_nullable
...
@override final  DateTime? calledInAt;
