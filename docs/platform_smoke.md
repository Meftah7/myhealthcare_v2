...
|---|---|---|---|
| **Windows** | ✅ `flutter build windows --release` → `build\windows\x64\runner\Release\myhealthcare.exe` (365 s) | ✅ seeded DB, login (all 3 roles), patient timeline/booking, staff dashboard + panel scan | Primary demo target. Also covered by 178 `flutter test` cases on the Windows VM. |
